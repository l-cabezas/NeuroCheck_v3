...
class ThemeLight implements ITheme {
  ...
  late final TextTheme textTheme = TextTheme(
    ...
    headline2: TextStyle(color: appColors.customBlackColor),
    headline3: TextStyle(color: appColors.customBlackColor),
    headline4: TextStyle(color: appColors.customBlackColor),
    headline5: TextStyle(color: appColors.textFieldHintColor),
    headline6: TextStyle(color: appColors.textFieldHintColor),
    overline: TextStyle(color: appColors.customBlackColor),
  );
