...
class AppColorsLight implements IAppColors {
  ...
  @override
  final Color primary = const Color(0xFFAED6F1) ;
  @override
  final Color secondary = const Color(0xFF5DADE2);
  ...
  @override
  final Color buttonColor = const Color(0xFF58b9f0);
  @override
  ...
  @override
  final Color customMarinerColor = const Color(0xFF5587D2);
  @override
...
/*  @override
  LinearGradient get gradientColor =>
      LinearGradient(
        ...
        colors: [Color(0xFF58b9f0),Colors.blue],
        stops: [0, 1],
      );*/
}
