...
class AppColorsDark implements IAppColors {
  ...
  @override
  final Color primary = const Color(0xFFB37ECC);
  @override
  final Color secondary = const Color(0xff4b8ac2);
  ...
  @override
  final Color textFieldCursorColor = const Color(0xfff7f7fc);
  @override
  ...
  @override
  final Color buttonColor = const Color(0xff7f65b6);
  @override
